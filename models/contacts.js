...
const addContact = async (req, res, next) => {
  try {
    ...
    const userId = req.user._id;
    const contact = await createContactService({ name, email, phone, favorite }, userId);    
...
const updateContact = async (req, res, next) => {
  ...
  try {
    ...
    const contact = await updateContactService(contactId, { name, email, phone, favorite }, userId);
...
const changeFavoriteStatus = async (req, res, next) => {
  ...
  try {
    ...
    const contact = await changeFavoriteStatusService(contactId, favorite, userId);
